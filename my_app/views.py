...
from my_app.models import Methodological_materials
...
class MaterialsListView(ListView):
    model = Methodological_materials
    template_name = 'my_app/lection.html'
    def get_queryset(self):
        return Methodological_materials.objects.filter(type=self.kwargs['TypeID'])
